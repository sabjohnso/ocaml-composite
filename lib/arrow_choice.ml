...
module Basic_arrow_choice_of_minimal_arrow_choice_choose
    (M : Minimal_arrow_choice_choose) =
struct
  include M
  ...
  let fanin f g =
    choose f g >>> arr (function Either.Left x -> x | Either.Right y -> y)
end
...
module Arrow_choice_of_minimal_arrow_choice_choose
    (M : Minimal_arrow_choice_choose) =
struct
  module Derived_arrow_choice = Arrow_choice_of_basic_arrow_choice (struct
...
module Arrow_choice_of_minimal_arrow_choice_choose_split
    (M : Minimal_arrow_choice_choose_split) =
struct
  module Derived_arrow_choice_ =
  Arrow_choice_of_minimal_arrow_choice_choose (struct
...
module Arrow_choice_of_minimal_arrow_choice_choose_first
    (M : Minimal_arrow_choice_choose_first) =
struct
  module Derived_arrow_choice_ =
  Arrow_choice_of_minimal_arrow_choice_choose (struct
