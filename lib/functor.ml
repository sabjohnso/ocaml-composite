...
module Applicative_of_minimal_applicative_fapply
    (M : Minimal_applicative_fapply) =
struct
  module Derived_functor_ = Functor_of_basic_functor (struct
    include M
...
module Applicative_of_minimal_applicative_product
    (M : Minimal_applicative_product) =
struct
  module Derived_functor_ = Functor_of_basic_functor (M)
  include Derived_functor_
  include M
...
module Basic_monad_of_minimal_monad_bind (M : Minimal_monad_bind) = struct
  ...
  Applicative_of_minimal_applicative_fapply (struct
    include M
...
module Basic_monad_of_minimal_monad_join (M : Minimal_monad_join) = struct
  ...
  module Derived_applicative_ =
  Applicative_of_minimal_applicative_product (struct
    include M
...
module Monad_of_minimal_monad_bind (M : Minimal_monad_bind) = struct
  ...
  module Derived_monad_ =
    Monad_of_basic_monad (Basic_monad_of_minimal_monad_bind (M))
...
module Monad_of_minimal_monad_join (M : Minimal_monad_join) = struct
  ...
  module Derived_monad_ =
    Monad_of_basic_monad (Basic_monad_of_minimal_monad_join (M))

  include Derived_monad_
end

module Monad_fail_of_minimal_monad_fail_bind (M : Minimal_monad_fail_bind) =
struct
  include M
  module Derived_monad = Monad_of_minimal_monad_bind (M)
  include Derived_monad
end

module Monad_fail_of_minimal_monad_fail_join (M : Minimal_monad_fail_join) =
struct
  include M
  module Derived_monad = Monad_of_minimal_monad_join (M)
  include Derived_monad
end

module Monad_plus_of_minimal_monad_plus_bind (M : Minimal_monad_plus_bind) =
struct
  include M
  module Derived_monad = Monad_fail_of_minimal_monad_fail_bind (M)

  let ( <|> ) = mplus
end

module Monad_plus_of_minimal_monad_plus_join (M : Minimal_monad_plus_join) =
struct
  include M
  module Derived_monad = Monad_fail_of_minimal_monad_fail_join (M)

  let ( <|> ) = mplus
end

module Basic_comonad_of_minimal_comonad_extend (M : Minimal_comonad_extend) =
struct
  include M
...
module Basic_comonad_of_minimal_comonad_duplicate
    (M : Minimal_comonad_duplicate) =
struct
  include M
...
module Comonad_of_minimal_comonad_extend (M : Minimal_comonad_extend) = struct
  ...
  module Derived_comonad =
    Comonad_of_basic_comonad (Basic_comonad_of_minimal_comonad_extend (M))

  include Derived_comonad
end

module Comonad_of_minimal_comonad_duplicate (M : Minimal_comonad_duplicate) =
struct
  include M

  module Derived_comonad =
    Comonad_of_basic_comonad (Basic_comonad_of_minimal_comonad_duplicate (M))
...
module Trivial_of_minimal_trivial (M : Minimal_trivial) = struct
  ...
  module Derived_monad__ = Monad_of_minimal_monad_bind (struct
    include M
