...
module type Minimal_monad_fail_bind = sig
  include Minimal_monad_bind

  val mzero : 'a t
end

module type Minimal_monad_fail_join = sig
  include Minimal_monad_join
...
module type Minimal_monad_plus_bind = sig
  include Minimal_monad_fail_bind

  val mplus : 'a t -> 'a t -> 'a t
end

module type Minimal_monad_plus_join = sig
  include Minimal_monad_fail_join
